...
> Відкрити цю сторінку в [https://si4karuk.github.io/snake/](https://si4karuk.github.io/snake/)
...
* шукайте **https://github.com/si4karuk/snake** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/si4karuk/snake/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/si4karuk/snake** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/si4karuk/snake/raw/master/.github/makecode/blocks.png)
